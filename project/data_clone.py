...
gunzip -c ~/Desktop/tofile/pfas-migrations/hawc_2019-11-18.Monday.sql.gz | psql -U postgres hawc
...
def main():
    deactivate_user()
    disable_signals()
    # TODO - rerun these again w/ the latest db
    clone_assessment(
        100000026,
        "PFHxA",
