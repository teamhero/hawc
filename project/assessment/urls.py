...
router.register(r'effecttag-autosuggest', api.EffectTagAutoSuggest, base_name='study-autosuggest')
router.register(r'effecttag-create', api.EffectTagCreate, base_name='study-create')
