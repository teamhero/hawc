...
class EndpointTypeSelector extends Component {
    ...
    render() {
        return (
            <div className={this.props.className}>
                <label className='control-label'>Endpoint filter (optional):</label>
...
EndpointTypeSelector.propTypes = {
    handleChange: PropTypes.func.isRequired,
};

export default EndpointTypeSelector;
