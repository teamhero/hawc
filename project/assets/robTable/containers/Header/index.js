...
class Header extends Component {
    ...
    render() {
        let headerText, smallText, helpText,
            { isForm, display, assessment_id } = this.props.config;
        if(assessment_id == '100500031'){
            helpText = 'Please disregard the drop-down selections. They will be assigned as "Not-applicable" post-review.';
        } else {
        ...
        if(isForm) {
            return (
                <div>
                    ...
                    <div className='help-text' dangerouslySetInnerHTML={{__html: helpText}}>
                    </div>
                </div>
            );
        } else {
