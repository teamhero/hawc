    ...
    render(){
        ...
        return (
            <div className='metric-display'>
                ...
                <ScoreForm ref='form' score={formScore} addText={this.state.addText} updateNotesLeft={updateNotesLeft} endpoints={this.props.endpoints} endpointscores={metric.endpointscores}/>
            </div>
        );
    }
}
